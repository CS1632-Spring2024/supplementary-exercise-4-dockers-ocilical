...
public class D3Test {
    ...
    public void tEST1LINKS() {
        ...
        js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
        {
            ...
            vars.put("theurl", attribute);
        }
        assertEquals(vars.get("theurl").toString(), "http://localhost:8080/reset");
    }
    ...
    public void tEST2RESET() {
        ...
        assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(1)")).getText(),
        ...
        assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(3)")).getText(),
    ...
    public void tEST4LISTING() {
        ...
        js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
        driver.findElement(By.linkText("Catalog")).click();
        vars.put("num", driver.findElements(By.xpath("//div/ul/li")).size());
        assertEquals(vars.get("num").toString(), "3");
        assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(3)")).getText(),
                is("ID 3. Mistoffelees"));
    }
